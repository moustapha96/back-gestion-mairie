 ...
 */
final class Version20260127090700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `gs_mairie_articles_terrains` (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, auteur_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, content LONGTEXT DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_B5715083BCF5E72D (categorie_id), INDEX IDX_B571508360BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `gs_mairie_attribuation_parcelle` ADD CONSTRAINT FK_FD50F1F980E95E18 FOREIGN KEY (demande_id) REFERENCES `gs_mairie_demande_terrains` (id)');
        ...
        $this->addSql('ALTER TABLE `gs_mairie_demande_terrains` ADD CONSTRAINT FK_C21F8678DF1E57AB FOREIGN KEY (quartier_id) REFERENCES `gs_mairie_localites` (id)');
        $this->addSql('ALTER TABLE `gs_mairie_demande_terrains` ADD CONSTRAINT FK_C21F8678FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES `gs_mairie_users` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `gs_mairie_demande_terrains` DROP FOREIGN KEY FK_C21F8678DF1E57AB');
        $this->addSql('ALTER TABLE `gs_mairie_demande_terrains` DROP FOREIGN KEY FK_C21F8678FB88E14F');
        ...
        $this->addSql('DROP TABLE `gs_mairie_demande_terrains`');
